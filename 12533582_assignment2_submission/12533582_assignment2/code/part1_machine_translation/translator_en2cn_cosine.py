...
def default_output_base_dir():
    return Path(__file__).resolve().parents[2] / "outputs" / "part1_machine_translation"
...
def main():
    parser = argparse.ArgumentParser(description="Train the English-to-Chinese Transformer with warm-up cosine LR.")
    parser.add_argument("--data-dir", type=Path, default=default_data_dir())
    parser.add_argument("--output-dir", type=Path, default=None)
    parser.add_argument("--assets-dir", type=Path, default=default_assets_dir())
    parser.add_argument("--name", default="cosine_peak1e-4")
    ...
    parser.add_argument("--pe-type", choices=["sinusoidal", "learnable"], default="sinusoidal")
